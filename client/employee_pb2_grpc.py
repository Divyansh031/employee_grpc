...
class EmployeeServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.CreateEmployee = channel.unary_unary(
                ...
                request_serializer=employee__pb2.CreateEmployeeRequest.SerializeToString,
                response_deserializer=employee__pb2.CreateEmployeeResponse.FromString,
        ...
        self.GetEmployee = channel.unary_unary(
                ...
                response_deserializer=employee__pb2.GetEmployeeResponse.FromString,
                _registered_method=True)
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateEmployee': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=employee__pb2.CreateEmployeeRequest.FromString,
                    response_serializer=employee__pb2.CreateEmployeeResponse.SerializeToString,
            ),
            'GetEmployee': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=employee__pb2.GetEmployeeResponse.SerializeToString,
            ),
...
class EmployeeService:
    ...
    def CreateEmployee(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/employee.EmployeeService/CreateEmployee',
            employee__pb2.CreateEmployeeRequest.SerializeToString,
            employee__pb2.CreateEmployeeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetEmployee(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            employee__pb2.GetEmployeeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
